...
ApplicationWindow {
    ...
    Rectangle
    {
        ...
        TextInput
        {
            ...
            visible: (spg_animation_y.running || (ma_mouse_area.active) )? false : true
            ...
            Keys.onReturnPressed:
            {
                ...
                {
                    ma_mouse_area.drag.target = rect_outer_ball
                }
...
//            anchors.verticalCenter: big_wrapper.verticalCenter
            ...
            MouseArea
            {
                ...
                //drag.active: Cursed_8_ball.get_is_draggable()? true:false
                onPressed:
                {
                    if(Cursed_8_ball.get_is_draggable())
                    {
                        txtin_input.visible = false
                    }
                }
                ...
                onReleased:
                {
                    ...
                    //txtin_input.visible = spg_animation_y.running ? false : true
                }
